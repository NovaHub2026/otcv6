...
| Subphase | Title                                                                      | State      |
| -------- | -------------------------------------------------------------------------- | ---------- |
| PH-27.1  | The guards that cannot fail: found by planting, fixed by anchoring         | **ACTIVE** |
| PH-27.2  | The records that are stale: every "leaves open" checked against the tree   | PLANNED    |
| PH-27.3  | The small improvements with no owner, closed                               | PLANNED    |
