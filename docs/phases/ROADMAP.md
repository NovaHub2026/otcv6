...
| Subphase | Title                                                            | State      |
| -------- | ---------------------------------------------------------------- | ---------- |
| PH-25.1  | An observer that builds a dataset from the served record alone   | **ACTIVE** |
| PH-25.2  | The battery on the served record, across a restart and a resume  | PLANNED    |
