...
| stream resumes exactly from M+1                                     | pass   | asked 201, got 201, 0 gaps                                                                                                         |
| stream refuses a sequence never published                           | pass   | status 400                                                                                                                         |
| a gap, when told, names where the record resumes                    | pass   | no gap told: the whole record was replayed from 1                                                                                  |
