...
thirty of PH-26 pass the realism suite at the gate but no per-asset table of
the fifteen has been recorded for them, which is the first measurement §1.2
...
| -------------------------------------------- | ------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----- | ------------------------------------------------------------------------------------------------------- |
| Intraday seasonality of activity (sessions)  | `structure.ts` shapes activity within a day by clock phase; no session calendar, no weekend | A per-asset activity profile keyed on the injected clock's hour and weekday (forex quiet on Sunday, equities dead outside the cash session, crypto flat). Time in, never price: class A. The battery already has clock-phase families and will police it.                                | A     | The `structure` term's amplitude per family vs a real intraday activity curve (public data, one week)   |
...
| Slow drift of the level (multi-week trends)  | Driftless by theorem; excursions supply "trends"                                            | None that keeps INV-006: any drift is a direction. Realised excursions measured at 13.7× a plain walk's heterogeneity (PH-3.1) is the honest substitute.                                                                                                                                 | C     | —                                                                                                       |
...
run the mirror on it (`Reproducir`, PH-24.10). What each act costs the
