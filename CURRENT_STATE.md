...
| Active subphase        | PH-29.1 — The settlement query                                     |
...
**Implement PH-29.1 (the settlement query) on `feature/ph-29-integration-boundary`; PH-28 is merged (`fd17ec0`), and hosted CI on it is recorded in the table above when it lands.**
