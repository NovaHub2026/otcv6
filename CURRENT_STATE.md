...
**Implement PH-29.2 (the API contract frozen) on `feature/ph-29-integration-boundary`; hosted CI on the PH-28 merge (`fd17ec0`) is recorded in the table above when it lands.**
