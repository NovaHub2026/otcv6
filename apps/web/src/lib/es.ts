  ...
  lab: {
    ...
    panel: {
      ...
      close: {
        ...
        next: 'próxima vela',
        price: 'tasa',
        pick: 'o haz clic en el gráfico',
        mark: 'cierre',
        conditions: {
          exact: 'termina exactamente en la tasa',
          above: 'termina en cualquier precio por encima de la tasa',
          below: 'termina en cualquier precio por debajo de la tasa',
        },
        noTimeframe:
