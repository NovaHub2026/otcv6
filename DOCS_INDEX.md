...
| [`docs/evidence/`](docs/evidence/)                 | SUPPORTING                       | Verification artefacts too large to keep in a phase document, including [CYCLE-7-DISPERSION.md](docs/evidence/CYCLE-7-DISPERSION.md), [CYCLE-6-DRIFT.md](docs/evidence/CYCLE-6-DRIFT.md) and [CYCLE-6-BACKFILL-SCALE.md](docs/evidence/CYCLE-6-BACKFILL-SCALE.md): [CYCLE-1-VERIFICATION.md](docs/evidence/CYCLE-1-VERIFICATION.md), [PH-11-HORIZON-COVERAGE.md](docs/evidence/PH-11-HORIZON-COVERAGE.md), [PH-11-COVERAGE.md](docs/evidence/PH-11-COVERAGE.md). Approvals otherwise record their measurements inline, next to the claim. |
