...
| [`docs/audits/`](docs/audits/)                     | CYCLE AUDIT                      | Records of three-phase Cycle Audits, including Memory Audit and Cold Start Audit results. Three have run: [001](docs/audits/CYCLE-AUDIT-001.md), [002](docs/audits/CYCLE-AUDIT-002.md), [003](docs/audits/CYCLE-AUDIT-003.md). |
| [`docs/evidence/`](docs/evidence/)                 | SUPPORTING                       | Verification artefacts too large to keep in a phase document: [CYCLE-1-VERIFICATION.md](docs/evidence/CYCLE-1-VERIFICATION.md). Approvals otherwise record their measurements inline, next to the claim.                       |
