...
export const ASSET_SEATS: readonly AssetSeat[] = [
  ...
  },
  {
    ...
    referencePrice: 85,
    priceSource:
      'CoinCodex daily closes, August 2026 (26 sessions, low 72.55 on Aug 6, late-month rally): mean 85.73 (sum 2,228.90; a transposition, 83.57, stood here until Cycle Audit 9 a3-06 re-summed the closes)',
    character:
